...
import { getIntegrationById, revokeIntegration } from "@/lib/flow/flow-store";
...
export async function POST(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const integration = await revokeIntegration(supabase, { tenantId: miembro.tenantId, integrationId: id });
