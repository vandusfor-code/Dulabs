...
export async function POST(request: NextRequest) {
  ...
  // Pipeline único (atención humana -> registro -> compra -> Agenda V2 -> entrada AMORE -> Flow Engine): ver
  // lib/whatsapp-qr-pipeline.ts -- la MISMA función que ejercitan los tests de conversación de punta a punta.
  const resultado = await atenderMensajeWhatsAppQR({
