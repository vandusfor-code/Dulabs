...
import { dispararBienvenidaDeveloper } from "@/lib/developer/welcome";
...
export async function POST(request: NextRequest) {
  return conUsuarioDeveloper(request, async (ctx) => {
    ...
    // Bienvenida (email + WhatsApp) SOLO en la primera provisión (created), una
    // única vez. No bloqueante: un fallo se loguea pero nunca hace fallar la
