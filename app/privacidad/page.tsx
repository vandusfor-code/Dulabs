      ...
      <div className="mx-auto w-full max-w-3xl">
        ...
        <article className={ARTICLE_CLASSNAME}>
          ...
          <ul>
            ...
            <li>
              <p><strong>{t("Sitio Web", "Website")}</strong> {t("se refiere a Du Labs, accesible desde", "refers to Du Labs, accessible from")} <a href="https://www.dulabs.co" rel="external nofollow noopener" target="_blank">https://www.dulabs.co</a>.</p>
            </li>
            <li>
