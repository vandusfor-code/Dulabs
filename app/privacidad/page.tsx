...
export const metadata: Metadata = {
  title: "Privacy Policy — Du Labs",
  description: "Privacy policy for Du Labs and its products (Du Life, Du Academy, Du IA Business).",
};
...
<li>
<p><strong>Application</strong> refers to Du Labs, the software program provided by the Company.</p>
</li>
<li>
<p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to Du Labs, Montería, Córdoba, Colombia.</p>
</li>
<li>
...
<li>
<p><strong>Website</strong> refers to Du Labs, accessible from <a href="https://dulabs.co" rel="external nofollow noopener" target="_blank">https://dulabs.co</a>.</p>
</li>
<li>
...
<ul>
<li>By email: vandusfor@gmail.com</li>
</ul>`;
