...
export function ProductMockup() {
  return (
    <div className="relative mx-auto flex justify-center">
      {/* Mobile / tablet / laptops angostos: solo el teléfono. La
          composición de escritorio es ancha a propósito (se ve mal
          achicada), así que el corte es en xl (1280px), no antes. */}
      <div className="xl:hidden">
        <PhoneDemo />
      </div>

      {/* Desktop ancho: laptop + teléfono */}
      <div className="relative hidden h-[560px] w-[640px] xl:block" style={{ perspective: "1800px" }}>
        {/* Glow ambiental muy sutil, no un verde intenso */}
        <div className="pointer-events-none absolute inset-x-6 bottom-4 h-48 rounded-full bg-site-primary/10 blur-[80px]" />
        ...
        <div className="absolute bottom-0 right-0 animate-site-float-phone">
          <div style={{ transform: "scale(0.68) rotateY(9deg) rotateX(-3deg)", transformOrigin: "bottom right" }}>
            <PhoneDemo />
          </div>
        </div>
      </div>
