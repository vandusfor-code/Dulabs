...
const ETAPAS: { n: string; titulo: string; texto: string }[] = [
  { n: "01", titulo: "Configura", texto: "Completa los pasos con la información de tu negocio." },
  { n: "02", titulo: "Prueba", texto: "La vista previa simula conversaciones con tu agente: no envía WhatsApp real ni ejecuta acciones de negocio." },
  { n: "03", titulo: "Publica", texto: "El sistema revisa que la configuración esté completa, guarda cada versión y conecta el agente a tu número de WhatsApp." },
];
    ...
    <HomeSection id="configuracion" titleId="configuracion-titulo">
      <SectionHeader eyebrow="Configuración sin programar" titleId="configuracion-titulo" title="Configura tu negocio. DuLabs lo convierte en un agente.">
        <p>
          ...
          agente, lo valida y lo publica en tu WhatsApp. No necesitas saber programar.
        </p>
      </SectionHeader>
      ...
      <ol className="mt-14 grid gap-8 border-t border-site-border pt-8 sm:grid-cols-3 sm:gap-10">
        {ETAPAS.map((e) => (
          <li key={e.n}>
